"""
    ...
    site_result_tuple(spac::BulkSPAC{FT}, wd::Union{Dict,OrderedDict}, saving_setting::Vector{ParameterFunctionMapper}) where {FT}
...
"""
function site_result_tuple(spac::BulkSPAC{FT}, wd::Union{Dict,OrderedDict}, saving_setting::Vector{ParameterFunctionMapper}) where {FT}
